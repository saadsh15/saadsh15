...
- 🔭 I’m currently working on exciting Open Source projects like **[ai_council](https://github.com/saadsh15/ai_council)**, a terminal-based multi-agent AI research platform.
- 🌱 I’m constantly learning and building tools for AI agents, like **[agent-skills](https://github.com/saadsh15/agent-skills)** and **[claude-skills](https://github.com/saadsh15/claude-skills)**.
- 👯 I’m looking to collaborate on Open Source AI tools, TypeScript applications, and Python-based utilities.
...
| 🧑‍💻 **[claude-skills](https://github.com/saadsh15/claude-skills)** | +192 Claude Code skills & agent plugins for 10+ coding agents. | Python |
...
| 👤 **[facial_recognition_webapp](https://github.com/saadsh15/facial_recognition_webapp)** | A real-time facial recognition app that uses Python (Flask) as a Server with a web UI. | Python |
| 🏗️ **[ProjectS-HomeForge](https://github.com/saadsh15/ProjectS-HomeForge)** | A TypeScript project. | TypeScript |
